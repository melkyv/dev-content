<div class="bg-white dark:bg-[#1e293b] rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 p-8">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-[#1e293b] dark:text-[#f1f5f9] mb-2">Bem-vindo de volta!</h1>
        <p class="text-[#64748b] dark:text-[#94a3b8]">Faça login para continuar</p>
    </div>
    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-between mb-6">
            <label class="flex items-center gap-2 cursor-pointer">
                ...
                >
                <span class="text-[#64748b] dark:text-[#94a3b8] text-sm">Lembrar-me</span>
            </label>
    ...
    <div class="flex items-center gap-4 my-6">
        ...
        <span class="text-[#64748b] dark:text-[#94a3b8] text-sm">Ou entre com</span>
        <div class="flex-1 border-t border-gray-200 dark:border-gray-700"></div>
    </div>
